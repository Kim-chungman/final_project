				    ...
				    <div class="inner group">
				        ...
				        <div id="content-blog" class="content group">
				            ...
				            <div class="sticky hentry hentry-post blog-big group">
				                ...
				                <div class="thumbnail">
				                    <!-- post title -->
				                    <h2 class="post-title"><a href="article.jsp">Section shortcodes &amp; sticky posts!</a></h2>
				                    <!-- post featured -->
				                    <div class="image-wrap">
				                        <img src="images/articles/001-816x282.jpg" alt="001" title="001" />        
				                    </div>
				                    <p class="date">
				                ...
				                <div class="meta group">
				                    ...
				                    <p class="comments"><span><a href="article.jsp#respond" title="Comment on Section shortcodes &amp; sticky posts!">No comments</a></span></p>
				                </div>
				                <!-- post content -->
				                <div class="the-content group">
				                    ...
				                    <p><a href="article.jsp" class="btn   btn-beetle-bus-goes-jamba-juice-4 btn-more-link">→ Read more</a></p>
				                </div>
				                <div class="clear"></div>
				            </div>
				            ...
				            <div class="hentry hentry-post blog-big group">
				                ...
				                <div class="thumbnail">
				                    <!-- post title -->
				                    <h2 class="post-title"><a href="article.jsp">Nice &amp; Clean. The best for your blog!</a></h2>
				                    <!-- post featured -->
				                    <div class="image-wrap">
				                        <img src="images/articles/003-816x282.jpg" alt="003" title="003" />        
				                    </div>
				                    <p class="date">
				                        <span class="month">Sep</span>
				                        <span class="day">24</span>
				                ...
				                <div class="meta group">
				                    <p class="author"><span>by <a href="#" title="Posts by Nicola Mustone" rel="author">Nicola Mustone</a></span></p>
				                    <p class="categories"><span>In: <a href="#" title="View all posts in Design" rel="category tag">Design</a>, <a href="#" title="View all posts in WordPress" rel="category tag">WordPress</a></span></p>
