				        ...
				        <div id="content-page" class="content group">
				            <div class="hentry group">
				                <div class="accordion-container">
				                    <h3 class="accordion-title"><span class="icon-plus-sign"></span> Susan</h3>
				                    <div class="accordion-item">
				                        <div class="accordion-item-thumb">
				                            <img src="images/avatar/jasmine1-129x176.png" alt="Susan" style="width:129px;" />
				                        </div>
				                    ...
				                    <div class="accordion-item">
				                        <div class="accordion-item-thumb">
				                            <img src="images/avatar/samuel1-130x176.png" alt="Samuel" style="width:129px;" />
				                        </div>
				                    ...
				                    <div class="accordion-item">
				                        <div class="accordion-item-thumb">
				                            <img src="images/avatar/susanna1-130x176.png" alt="Jasmine" style="width:129px;" />
				                        </div>
				                        <div class="accordion-item-content" style="margin-left: 162px;">
				                            <h4>Copywriter</h4>
				                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. <strong>Sed nec placerat odio</strong>. Vestibulum in orci nec turpis ultrices malesuada at et dolor. Praesent dapibus augue ac mauris fringilla condimentum vestibulum!</p>
				                    ...
				                    <div class="accordion-item">
				                        <div class="accordion-item-thumb">
				                            <img src="images/avatar/thomas1-130x176.png" alt="Thomas" style="width:129px;" />
				                        </div>
				                        <div class="accordion-item-content" style="margin-left: 162px;">
				                            <h4>Sales Account</h4>
				                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. <strong>Sed nec placerat odio</strong>. Vestibulum in orci nec turpis ultrices malesuada at et dolor. Praesent dapibus augue ac mauris fringilla condimentum vestibulum!</p>
				                    ...
				                    <div class="accordion-item">
				                        <div class="accordion-item-thumb">
				                            <img src="images/avatar/victor1-130x176.png" alt="Victor" style="width:129px;" />
				                        </div>
				                        <div class="accordion-item-content" style="margin-left: 162px;">
				        ...
				        <div id="sidebar-testimonials" class="sidebar group">
				            ...
				            <div class="widget-last widget featured-projects">
				                ...
				                <div class="featured-projects-widget flexslider">
				                    <ul class="slides">
				                        <li>
				                            <div class="thumb-project"><a href="project.jsp"><img src="images/projects/0061-320x154.jpg" alt="0061" title="0061" /></a></div>
				                            <h4>Love</h4>
				                            <p class="categories"><a href="category.jsp">Brand Identity</a>, <a href="category.jsp">Web Design</a></p>
				                        </li>
				                        <li>
				                            <div class="thumb-project"><a href="project.jsp"><img src="images/projects/0071-320x154.jpg" alt="0071" title="0071" /></a></div>
				                            <h4>Kineda</h4>
				                            <p class="categories"></p>
				                        </li>
				                        <li>
				                            <div class="thumb-project"><a href="project.jsp"><img src="images/projects/0081-320x154.jpg" alt="0081" title="0081" /></a></div>
				                            <h4>Steep This!</h4>
				                            <p class="categories"><a href="category.jsp">Brand Identity</a>, <a href="category.jsp">Web Design</a></p>
				                        </li>
				                        <li>
				                            <div class="thumb-project"><a href="project.jsp"><img src="images/projects/009-320x154.jpg" alt="009" title="009" /></a></div>
				                            <h4>Guanacos</h4>
				                            <p class="categories"></p>
				                        </li>
				                        <li>
				                            <div class="thumb-project"><a href="project.jsp"><img src="images/projects/0011-320x154.jpg" alt="0011" title="0011" /></a></div>
				                            <h4>Miller Bob</h4>
				                            <p class="categories"></p>
				                        </li>
				                    </ul>
