...
<ol class="owm-fin-tab2 clearfix" style="margin-top: 15px; background-color: #F7F9FC; vertical-align: middle; padding-top: 50px;">
    <li style="list-style: none; margin-left: 100px;">
        <a href="#" style="color: #008B8B; font-size: 14pt;">
            <strong style="color: #008B8B;">2030’s</strong><span style="font-size: 12pt;">사회초년기·자산형성기</span>
        </a>
    </li>
    <li style="list-style: none; margin-left: 20px;">
        <a href="#" style="font-size: 14pt;">
            <strong>3040’s</strong><span style="font-size: 12pt;">가족형성기·자산증식기</span>
        </a>
    </li>
    <li style="list-style: none; margin-left: 20px;">
        <a href="#" style="font-size: 14pt;">
            <strong>4050’s</strong><span style="font-size: 12pt;">노후준비기·자산보존기</span>
        </a>
    </li>
    <li style="list-style: none; margin-left: 20px;">
        <a href="#" style="font-size: 14pt;">
            <strong>5060’s</strong><span style="font-size: 12pt;">청춘100세·제2의 인생</span>
        </a>
    </li>
</ol>
