	...
	<script>
	   ...
	   function drawChart() {
		      ...
		      var jsonData = $.ajax({
		         ...
		         url : "${ pageContext.request.contextPath }/adminPage/customerExpense",
		         data: { id: idCheck},
		         dataType : "JSON",
		         async : false
		      }).responseText;
	   ...
	   function drawChart2() {
		         ...
		         url : "${ pageContext.request.contextPath }/adminPage/customerAge",
		         data: { member_id : id },
		         dataType : "JSON",
		         async : false
		      }).responseText;
		      ...
		      chart.draw(data, {
		         ...
		         height : 400,
		         pieHole: 0.5,
		         colors: ['#FAC8C8','LightBlue', '#FFDAAB', 'Thistle', '#46BEFF'],
		         chartArea: {
		        	 'width': '98%',
		        	 'height' : '90%'
		       	}
	   ...
	   function drawPieChart3() {
		      ...
		      var jsonData = $.ajax({
		         ...
		         url : "${ pageContext.request.contextPath }/adminPage/customerAvg",
		         data: { id: idCheck},
		         dataType : "JSON",
		         async : false
		      }).responseText;
            ...
            <div class="mt-2">
              ...
              <div class="grid grid-cols-1 gap-8 p-4 lg:grid-cols-2 xl:grid-cols-4">
                ...
                <div class="flex items-center justify-between p-4 bg-white rounded-md dark:bg-darker">
                  <div>
                    ...
                    <span class="text-xl font-semibold">$6,552,930</span>
                  </div>
                  <div>
                    <span>
                      <svg
                ...
                <div class="flex items-center justify-between p-4 bg-white rounded-md dark:bg-darker">
                  <div>
                    ...
                    <span class="text-xl font-semibold">1200명</span>
                ...
                <div class="flex items-center justify-between p-4 bg-white rounded-md dark:bg-darker">
                  <div>
                    ...
                    <span class="text-xl font-semibold">$340,753</span>
                    <span class="inline-block px-2 py-px ml-2 text-xs text-green-500 bg-green-100 rounded-md">
                      +5.2%
                    </span>
                  </div>
              ...
              <div class="grid grid-cols-1 p-4 space-y-8 lg:gap-8 lg:space-y-0 lg:grid-cols-3">
                ...
                <div class="col-span-2 bg-white rounded-md dark:bg-darker" x-data="{ isOn: false }">
                  ...
                  <div class="flex items-center justify-between p-4 border-b dark:border-primary">
                    <h4 class="text-lg font-semibold text-gray-500 dark:text-light">최근 1년간 관리고객 소비지출액</h4>
                ...
                <div class="bg-white rounded-md dark:bg-darker" x-data="{ isOn: false }">
                  <!-- Card header -->
                  <div class="flex items-center justify-between p-4 border-b dark:border-primary">
                    <h4 class="text-lg font-semibold text-gray-500 dark:text-light">고객 연령대</h4>
              ...
              <!-- Two grid columns -->
                ...
                <div class="col-span-2 bg-white rounded-md dark:bg-darker" x-data="{ isOn: false }" style="width: 98%; margin-left: 15px;">
                  <!-- Card header -->
                  <div class="flex items-center justify-between p-4 border-b dark:border-primary">
                    <h4 class="text-lg font-semibold text-gray-500 dark:text-light">연령대별 월 저축액 비교</h4>
                ...
                <a href="#" class="block">
                  <div class="flex px-4 space-x-4">
                    ...
                    <div class="flex-1 overflow-hidden">
                      ...
                      <span class="text-sm font-normal text-gray-400 dark:text-primary-light"> 3h ago </span>
                    </div>
                  </div>
                </a>
                <a href="#" class="block">
                  <div class="flex px-4 space-x-4">
                    ...
                    <div class="flex-1 overflow-hidden">
                      ...
                      <span class="text-sm font-normal text-gray-400 dark:text-primary-light"> 4h ago </span>
                    </div>
                  </div>
                </a>
                  <a href="#" class="block">
                    <div class="flex px-4 space-x-4">
                      ...
                      <div class="flex-1 overflow-hidden">
                        ...
                        <span class="text-sm font-normal text-gray-400 dark:text-primary-light"> 6h ago </span>
                      </div>
                    </div>
                  </a>
              </div>
              ...
              <div class="space-y-4" x-show.transition.in="activeTabe == 'user'">
                <a href="#" class="block">
                  <div class="flex px-4 space-x-4">
                    <div class="relative flex-shrink-0">
                      <span class="relative z-10 inline-block overflow-visible rounded-ful">
                        <img
                          ...
                          src="${ pageContext.request.contextPath }/resources/dashboard/public/build/images/avatar2.png"
                          alt="Ahmed kamel"
                        />
                      </span>
                      <div class="absolute h-24 p-px -mt-3 -ml-px bg-primary-50 left-1/2 dark:bg-primary-darker"></div>
                    ...
                    <div class="flex-1 overflow-hidden">
                      <h5 class="text-sm font-semibold text-gray-600 dark:text-light">김충만</h5>
                      <p class="text-sm font-normal text-gray-400 truncate dark:text-primary-lighter">
                        김대리님 일정 확인 부탁드립니다.
                      </p>
                      <span class="text-sm font-normal text-gray-400 dark:text-primary-light"> 1h ago </span>
                    </div>
                  </div>
                </a>
                <a href="#" class="block">
                  <div class="flex px-4 space-x-4">
                    <div class="relative flex-shrink-0">
                      <span class="relative z-10 inline-block overflow-visible rounded-ful">
                        <img
                          class="object-cover rounded-full w-9 h-9"
                          src="${ pageContext.request.contextPath }/resources/dashboard/public/build/images/avatar.png"
                          alt="Ahmed kamel"
                        />
                      </span>
                      <div class="absolute h-24 p-px -mt-3 -ml-px bg-primary-50 left-1/2 dark:bg-primary-darker"></div>
                    ...
                    <div class="flex-1 overflow-hidden">
                      <h5 class="text-sm font-semibold text-gray-600 dark:text-light">김하나</h5>
                      <p class="text-sm font-normal text-gray-400 truncate dark:text-primary-lighter">
                        김하나 고객님이 메일을 확인하셨습니다.
                      </p>
                      <span class="text-sm font-normal text-gray-400 dark:text-primary-light"> 2h ago </span>
                    </div>
                  </div>
                </a>
