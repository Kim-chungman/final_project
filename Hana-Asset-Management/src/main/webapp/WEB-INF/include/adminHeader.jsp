...
<body>
	<!-- Navbar -->
    <header class="relative bg-white dark:bg-darker" style="background-color: #008B8B;">
        ...
        <nav aria-label="Secondary" class="hidden space-x-2 md:flex md:items-center">
          ...
          <div class="relative" x-data="{ open: false }">
            ...
            >
              ...
              <img class="w-10 h-10 rounded-full" src="${ pageContext.request.contextPath }/resources/dashboard/public/build/images/avatar2.png" alt="Ahmed Kamel" />
            </button>
